...
<div class="wrapper-info">
    ...
    <div class="col-right">
		...
		<div class="update-now">
			<h4><?php esc_html_e('Buy VW Restaurant at 10% Discount','vw-restaurant-lite'); ?></h4>
			<h4><?php esc_html_e('Use Coupon','vw-restaurant-lite'); ?> ( <span><?php esc_html_e('vwten2018','vw-restaurant-lite'); ?></span> ) </h4> 
			<div class="info-link">
    ...
    <div class="tab-sec">
		<div class="tab">
		  <button class="tablinks" onclick="openCity(event, 'lite_theme')"><?php esc_html_e( 'Getting Started', 'vw-restaurant-lite' ); ?></button>		  
		  <button class="tablinks" onclick="openCity(event, 'pro_theme')"><?php esc_html_e( 'Get Premium', 'vw-restaurant-lite' ); ?></button>
		  <button class="tablinks" onclick="openCity(event, 'free_pro')"><?php esc_html_e( 'Support', 'vw-restaurant-lite' ); ?></button>
		</div>
				...
				<div class="info-link">
					...
					<div class="first-row">
						<div class="row-box">
							...
							<div class="row-box2">
								<span class="dashicons dashicons-admin-customizer"></span><a href="<?php echo esc_url( admin_url('customize.php?autofocus[section]=vw_restaurant_lite_typography') ); ?>" target="_blank"><?php esc_html_e('Typography','vw-restaurant-lite'); ?></a>
							</div>
						</div>
						<div class="row-box">
							<div class="row-box1">
						...
						<div class="row-box">
							...
							<div class="row-box2">
								<span class="dashicons dashicons-admin-links"></span><a href="<?php echo esc_url( admin_url('customize.php?autofocus[section]=vw_restaurant_lite_topbar_header') ); ?>" target="_blank"><?php esc_html_e('Add Social Icon','vw-restaurant-lite'); ?></a>
							</div>
						</div>
						<div class="row-box">
							<div class="row-box1">
		...
		<div id="free_pro" class="tabcontent">
		  	...
		  	<div class="col-3">
		  		<h4><span class="dashicons dashicons-sos"></span><?php esc_html_e('Post-purchase Queries', 'vw-restaurant-lite'); ?></h4>
		  	...
		  	<div class="col-3">
		  		<h4><span class="dashicons dashicons-media-text"></span><?php esc_html_e('Theme Demo Content', 'vw-restaurant-lite'); ?></h4>
				<p> <?php esc_html_e('We are providing the demo content file within the theme folder.  You will require an importer plugin to import the demo content.', 'vw-restaurant-lite'); ?></p>
				<div class="info-link">
					<a href="<?php echo esc_url( VW_RESTAURANT_LITE_DEMO_DATA ); ?>" target="_blank"><?php esc_html_e('Demo Content', 'vw-restaurant-lite'); ?></a>
				</div>
		  	</div>
		</div>
	</div>
