...
* Description: A Restaurant Plugin (not only for Pizza) | <a href="http://docs.wp-pizza.com/getting-started/?section=setup" target="_blank">Getting started</a> | <a href="http://docs.wp-pizza.com" target="_blank">Documentation</a> | <a href="https://wordpress.org/plugins/wppizza/#developers" target="_blank">Changelog</a>
* Version: 3.7
* Author: ollybach
...
*	always set in line with plugin version number above
*	@since v3
*/
define('WPPIZZA_VERSION', '3.7');/** set in line with plugin version number **/
		...
		public static function instance() {
			...
			if ( ! isset( self::$instance ) && ! ( self::$instance instanceof WPPIZZA ) ) {
				...
				**/
				...
				/**
					templates | shortcodes | widget markup
				**/
