	...
	function gateway_get_options($gateway_object, $gateway_options_set, $type){
		...
		**/
		...
		/**
			logging
		**/
		//if(empty($gateway_object->gatewayNoDebug)){
		//	$gateway_default_options['_gateway_logging']					= (!empty($gateway_options_set['_gateway_logging']) || $save_defaults) ? true : false;
		//	$gateway_default_options['_gateway_failedorder_to_admin']		= (empty($gateway_options_set['_gateway_failedorder_to_admin']) || $save_defaults) ? false : true;
		//}
