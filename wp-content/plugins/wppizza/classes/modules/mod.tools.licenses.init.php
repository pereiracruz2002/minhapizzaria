...
*
* @package     WPPIZZA
* @subpackage  WPPIZZA_MODULE_TOOLS_LICENSES_INIT
	...
	*********************************************************/
	...
	function sections_header($settings, $sections){
		if($settings['id']==$this->section_key){
			...
			echo''.__('To ensure backwards compatibility licence key settings might additionally also still be available for plugins/gateways in their dedicated licence settings page and can interchangeably be set there.', 'wppizza-admin').'<br />';
