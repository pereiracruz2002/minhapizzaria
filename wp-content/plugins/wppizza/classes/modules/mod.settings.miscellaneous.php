	...
	function admin_options_settings($settings, $sections, $fields, $inputs, $help){
		...
		if($fields){
			...
			$settings['fields'][$this->section_key][$field] = array( __('Dequeue wppizza scripts', 'wppizza-admin'), array(
				'value_key'=>$field,
				'option_key'=>$this->settings_page,
				'label'=>__('If you are *certain* you do not require the main wppizza javascript and jquery validation and nothing else depends on them, or another plugin is already including jquery validation elsewhere, use the settings above as required. if you do not now, just leave it as is', 'wppizza-admin'),
				'description'=>array()
			));						
		}
