...
//			//add_action('wppizza_settings_sections_header_'.$this->settings_page.'', array( $this, 'sections_header'), 10, 2 );
		...
		*/
		...
		if ( version_compare( $wp_version, '4.9.6', '>=' ) ) {
			add_filter('wppizza_register_formfields',array( $this, 'register_formfields_accept_privacy_checkbox'), 100, 2);
		}
	...
	********************************************************************************************************************************************************/
	...
	function data_exporter( $email_address, $page = 1 ){
		...
		*/
		...
		$orders_for_export = WPPIZZA()->db->get_orders($args);
	...
	********************************************************************************************************************************************************/
	...
	#	@return array()
	------------------------------------------------------------------------------*/
	function register_formfields_accept_privacy_checkbox($formfields, $page){
		...
		if('publish' == $privacy_link_status){
			...
			$privacy_terms_label = ($page == 'orderpage') ? sprintf($wppizza_options['localization']['privacy_terms_accept'], $privacy_permalink) : $wppizza_options['localization']['privacy_terms_accepted'] ;
