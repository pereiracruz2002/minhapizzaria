				...
				$markup['tbody_']= '<tbody class="' . $class_tbody . '"' . $style_tbody . '>';
					...
					*/
					...
					foreach($items as $key=>$item){
						...
						/* price label - wrap in span (and a space before) if not empty */
						...
						**********/
						$menu_item['tr_']= '<tr id="'.$id_row_prefix . $key.'" class="'.$class_tr.'">';
							...
							$menu_item_columns['item_td_article']	= '<td class="'.$class_article_td.'"><span class="'.$class_article_title.'">'.$item['title'].'</span>'.$item['price_label'].'</td>';
