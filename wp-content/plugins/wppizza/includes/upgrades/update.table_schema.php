...
$table_schema_sql['create_'] = 'CREATE TABLE '. $table .' ('.PHP_EOL;
	$table_schema_sql['id'] = "id INT(10) NOT NULL AUTO_INCREMENT,".PHP_EOL;
	...
	$table_schema_sql['email'] = "email VARCHAR(256) NULL DEFAULT NULL COLLATE utf8mb4_unicode_ci,".PHP_EOL;// 256 chars should be plenty for emails up to 100 chars or so when encrypted
