	...
	global $wppizza_options;
			...
			***/
			...
			if (is_admin()) {
				...
				**************************************/
				require_once(WPPIZZA_PATH .'classes/admin/class.wppizza.dashboard_widgets.php');
			...
			**************************************/
			...
			/**************************************
				[include filters for orders - autoload]
			**************************************/
			require_once(WPPIZZA_PATH .'classes/class.wppizza.filter.orders.php');
